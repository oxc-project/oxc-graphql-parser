...
/// ### Diagnostics
///
/// Using something like [miette crate] along with oxc-graphql lets you have
/// more visual diagnostics. [miette] and [annotate_snippets] examples guide you
/// through integrating them with oxc-graphql. These are useful if you are
/// displaying Errors in a terminal-like environment.
///
/// <img src="https://raw.githubusercontent.com/oxc-project/oxc-graphql/main/crates/oxc-graphql/screenshots/oxc_graphql_error.png" alt="A screenshot of an error example produced by using oxc-graphql and miette. The ascii display shows a graphql code snippet with line numbers to the left. Under the code sample there is a line pointing to where a value is missing in graphql code">
///
/// [miette]: https://github.com/oxc-project/oxc-graphql/blob/main/crates/oxc-graphql/examples/miette.rs
/// [annotate_snippets]: https://github.com/oxc-project/oxc-graphql/blob/main/crates/oxc-graphql/examples/annotate_snippet.rs
...
impl Error {
    ...
    /// `oxc-graphql` has found to be lexically or syntactically incorrect.
