...
* [**`oxc-graphql-parser`**](crates/oxc_graphql_parser) - a library to parse GraphQL
...
If you try out `oxc-graphql-parser` and run into trouble, we encourage you to open an [issue].
